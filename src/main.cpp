...
#include "generated/dbz1_config.h"
...
class Dbz1App : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    ...
    Dbz1App(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "dbz1", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "dbz1", 1280, 720);
        if (!window_) {
...
GUEST_FUNCTION_STUB(__imp__XeCryptBnQwBeSigVerify);
GUEST_FUNCTION_STUB(__imp__XeKeysGetKey);
GUEST_FUNCTION_STUB(__imp__XeCryptRotSumSha);